module.exports = {
	...
	module: {
		noParse: /^(vue|vue-router|vuex|vuex-router-sync)$/, //不解析
		rules: [
			...
			/* config.module.rule('css') */
			{
				...
				oneOf: [
					...
					{
						resourceQuery: /module/, //为了处理<style lang=module>
						use: [
